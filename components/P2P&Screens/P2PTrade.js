...
import { ChevronDown, ArrowLeft, Shield, Clock, DollarSign } from "lucide-react-native"
    ...
    <View style={styles.emptyStateContainer}>
      <View style={styles.emptyStateContent}>
        ...
        <Text style={styles.emptyStateDescription}>
          There are currently no {selectedCrypto} {activeOrderType.toLowerCase()} offers available in {selectedCurrency}
    ...
    <View style={styles.traderCard}>
      ...
      <View style={styles.traderHeader}>
        <View style={styles.traderInfo}>
          ...
          {item.isVerified && <Shield size={14} color="#F0B90B" style={styles.verifiedIcon} />}
        </View>
      ...
      <View style={styles.priceSection}>
        ...
        <View style={styles.cryptoInfo}>
          <Image source={cryptoCurrencies.find((c) => c.code === item.cryptoType)?.logo} style={styles.cryptoIcon} />
      ...
      <View style={styles.actionSection}>
        ...
        <TouchableOpacity
          style={[styles.actionButton, activeOrderType === "Buy" ? styles.buyButton : styles.sellButton]}
          onPress={() =>
      ...
      <View style={styles.modalOverlay}>
        <View style={styles.modalContainer}>
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <TouchableOpacity
                style={[styles.modalItem, selectedCrypto === item.code && styles.selectedModalItem]}
      ...
      <View style={styles.modalOverlay}>
        <View style={styles.modalContainer}>
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <TouchableOpacity
                style={[styles.modalItem, selectedCurrency === item.code && styles.selectedModalItem]}
      ...
      <View style={styles.modalOverlay}>
        <View style={styles.modalContainer}>
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <TouchableOpacity
                style={[styles.modalItem, selectedSort === item.label && styles.selectedModalItem]}
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <TouchableOpacity style={styles.currencySelector} onPress={() => setCurrencyModalVisible(true)}>
        ...
        <View style={styles.buySellToggleContainer}>
          <TouchableOpacity
            style={[
              ...
              activeOrderType === "Buy" ? styles.buySellToggleActive : styles.buySellToggleInactive,
            ]}
            onPress={() => setActiveOrderType("Buy")}
          >
            <Text style={[styles.buySellToggleText, activeOrderType === "Buy" && styles.buySellToggleTextActive]}>
              Buy Crypto
            </Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            style={[
              styles.buySellToggleButton,
              activeOrderType === "Sell" ? styles.buySellToggleActive : styles.buySellToggleInactive,
            ]}
            onPress={() => setActiveOrderType("Sell")}
          >
            <Text style={[styles.buySellToggleText, activeOrderType === "Sell" && styles.buySellToggleTextActive]}>
              Sell Crypto
            </Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.filtersContainer}>
          {/* Crypto Filter */}
          <TouchableOpacity style={styles.filterButton} onPress={() => setCryptoModalVisible(true)}>
            <View style={styles.filterContent}>
              <Image
                source={cryptoCurrencies.find((c) => c.code === selectedCrypto)?.logo}
        ...
        <FlatList
          ...
          contentContainerStyle={sortedTraders.length === 0 ? { flex: 1 } : { paddingBottom: 20 }}
